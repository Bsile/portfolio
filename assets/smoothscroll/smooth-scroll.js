...
(function() {
    function C() {
        if (!D && document.body) {
            ...
            if (top != self)
                ...
                k.offsetHeight <= d && (d = document.createElement("div"),
                d.style.clear = "both",
                a.appendChild(d))
            }
    ...
    function N(a, b, d) {
        ...
        if (!F) {
            ...
            var h = function(c) {
                ...
                e ? window.scrollBy(g, k) : (g && (a.scrollLeft += g),
                k && (a.scrollTop += k));
                b || d || (t = []);
                t.length ? Q(h, a, 1E3 / f.frameRate + 1) : (F = !1,
    ...
    function R(a) {
        ...
        ga && (a.wheelDeltaX && x(a.wheelDeltaX, 120) && (d = -120 * (a.wheelDeltaX / Math.abs(a.wheelDeltaX))),
        a.wheelDeltaY && x(a.wheelDeltaY, 120) && (c = -120 * (a.wheelDeltaY / Math.abs(a.wheelDeltaY))));
    ...
    function M(a) {
        ...
        if (c || b.isContentEditable || d || (r(b, "button") || r(b, "input") && e.test(b.type)) && a.keyCode === h.spacebar || r(b, "input") && "radio" == b.type && ia[a.keyCode])
            return !0;
        c = b = 0;
        d = S(m);
        if (!d)
    ...
    var aa = {
        ...
        x: 0,
        y: 0
    }, D = !1, k = document.documentElement, m, z, w, l = [], Z, ga = /^Mac/.test(navigator.platform), h = {
        left: 37,
        up: 38,
        right: 39,
        down: 40,
    ...
    L && g && (window.addEventListener(L, R, u || !1),
